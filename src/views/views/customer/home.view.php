...
?>
    ...
    <head>
        ...
        <!--        <link href="--><?php //= GlobalMethods::ROOT() ?><!--/assets/src/output.css" rel="stylesheet">-->
        <title>Shop</title>
    </head>
    ...
    GlobalMethods::setPage('Shop');
    include "includes/header/nav.php";
    include "views/includes/background/bg.include.php";
    ?>
    ...
    <section class="my-8">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
            <h1 class="text-3xl font-bold mb-6">Top Products</h1>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <?php for ($i = 0; $i < 12; $i++) {
                    require 'views/includes/cards/productCard.include.php';
                } ?>
            </div>
        </div>
