...
<section class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md lg:col-span-2">
        <div class="container mx-auto px-4 py-4">
            <h2 class="capitalize font-bold tracking-[0.025em] text-[clamp(2rem,1.8125rem+0.75vw,2.6rem)]">User privacy
                policy</h2>
        </div>
...
<script type="text/javascript" src="./assets/js/home/navbar.js"></script>
</body>
</html>
<?php
