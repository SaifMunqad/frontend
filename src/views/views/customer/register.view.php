...
GlobalMethods::setPage('Register');
...
<div class="h-screen md:flex">
    <div class="relative overflow-hidden md:flex w-1/2 justify-around items-center hidden">
        <div class=""><img
                src="<?= GlobalMethods::ROOT() ?>/resources/images/login4.jpg" alt="Background Image"
                class="w-full h-full object-cover">
        </div>
        <!-- Logo Image --> <img src="<?= GlobalMethods::ROOT() ?>/resources/images/company_logo.png"
                                 alt="Logo Image"
                                 class="absolute top-10 left-10 h-6">
    </div>
    <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
        <form class="bg-white" method="post" id="register">
            ...
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                ...
                <input class="pl-2 outline-none border-none" type="text" name="fullname" id="" pattern="[a-zA-Z ]+"
            ...
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                ...
                <input class="pl-2 outline-none border-none" type="text" name="username" id="" pattern="[a-zA-Z0-9]+"
            ...
            <!-- Login Section -->
            <div class="flex items-center justify-center mt-6"><p class="text-gray-700">Already a member?</p> <a
                    href="/login" class="ml-1 text-gray-800 font-bold underline">Login</a></div>
...
<script>
    document.getElementById('register').onsubmit = function () {
        this.action = '<?= GlobalMethods::ROOT() ?>/controllers/register'; // Set the action URL dynamically
    }
