<div class="h-full bg-white flex flex-col rounded-xl overflow-hidden">
    <!-- body -->
    <div class="h-full flex">
        <!-- sidebar 2 -->
        <div class="h-full w-100 bg-slate-50 border-r flex flex-col">
                    ...
                    <div class="w-1/2">
                        ...
                        <div class="mt-3 w-full bg-slate-50 p-4 rounded-b-xl rounded-tr-xl">
                            <p class=" text-sm text-slate-500">
                                Hey all, <br>
                                There are many variation of passages of Lorem ipsum avaliable, but the jority have
                                alternation in some form , by injected humor, or randomise words which don't look
