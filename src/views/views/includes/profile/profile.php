<div
    class="bg-white mx-auto w-full p-8 transition-all duration-300 animate-fade-in">
    <div class="flex flex-col md:flex-row">
        ...
        <div class="md:w-2/3 md:pl-8">
            ...
            <h2 class="text-xl font-semibold text-indigo-800  mb-4">Bio</h2>
            ...
            <h2 class="text-xl font-semibold text-indigo-800 mb-4">Skills</h2>
