...
@section('content')
    <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        ...
        <div class="border-b mb-5 flex justify-between text-sm">
            <div
                    class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 dark:border-indigo-300 dark:text-indigo-300 uppercase">
            ...
            <a href="#" class="text-indigo-600 dark:text-indigo-300 hover:text-indigo-800 dark:hover:text-indigo-500">See
                All</a>
        </div>
            ...
            @for($i = 0; $i<12; $i++)
                ...
                <div class="rounded overflow-hidden shadow-lg flex flex-col">
                    ...
                    <div class="relative"><a href="#">
                        ...
                        <a href="#!">
                            <div
                                    class="text-xs absolute top-0 left-0 bg-indigo-600 px-4 py-2 text-white hover:bg-white hover:text-indigo-600 transition duration-500 ease-in-out">
                                Cooking
                            </div>
                        </a>
                    </div>
                    <div class="px-6 py-4 mb-auto bg-white dark:bg-gray-800 ">
                        <a href="#"
                           class="font-medium text-lg inline-block text-gray-900 dark:text-gray-100 hover:text-indigo-600 dark:hover:text-indigo-300 transition duration-500 ease-in-out inline-block mb-2">
    ...
    <span href="#" class="py-1 text-xs font-regular text-gray-900 dark:text-gray-300 mr-1 flex flex-row items-center">
        <svg height="13px" width="13px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        ...
        <span class="ml-1 dark:text-gray-300">6 mins ago</span>
    </span>

                        <span href="#"
                              class="py-1 text-xs font-regular text-gray-900 dark:text-gray-300 mr-1 flex flex-row items-center">
        <svg class="h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z">
            </path>
        </svg>
        <span class="ml-1 dark:text-gray-300">138 Comments</span>
    </span>
                    </div>
