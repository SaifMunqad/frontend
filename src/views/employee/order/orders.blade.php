    ...
    <div class=" mr-3 mb-3 rounded-md lg:col-span-2 dark:bg-gray-900 text-gray-700 dark:text-gray-300">
        <div class="relative mx-4 mt-4 overflow-hidden">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Order List</h3>
                    <p class="text-gray-500 dark:text-gray-400">Review each Order before fund or delete!</p>
                </div>
                ...
                @foreach($employees as $employee)
                    <tr class="bg-gray-100 dark:bg-gray-800">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="#"
                               class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">Fund</a>
                            <a href="#"
