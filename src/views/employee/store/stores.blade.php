...
@section('content')
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        @for($i = 0; $i<12; $i++)
            ...
            <div
                class="max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900 relative">
                ...
                <div class="absolute right-0 top-0 mt-2 mr-4">
                    <div class="relative">
                        <!-- Three dots menu -->
                        <button class="text-gray-200 dark:text-gray-50 focus:outline-none"
                        ...
                        <div
                            class="opacity-0 scale-0 absolute right-0 z-10 mt-0 w-48 origin-top-right rounded-md bg-white dark:bg-gray-800 py-1 shadow-lg ring-1 ring-black/5 dark:ring-white/10 focus:outline-none transform"
                            role="menu" id="dropdown_menu" aria-orientation="vertical"
                            ...
                            <a href="/store/settings/profile"
                               ...
                               tabindex="-1"
                               id="user-menu-item-0">View store</a>
                ...
                <div class="p-4 border-t mx-8 mt-2">
                    <button
                        class="w-1/2 block mx-auto rounded-full bg-red-600 hover:shadow-lg font-semibold text-white px-6 py-2">
                        Delete
                    </button>
                </div>
            </div>
