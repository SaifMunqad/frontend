...
@section('content')
    <div class="h-screen md:flex">
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white dark:bg-gray-900">
            <form class="bg-white dark:bg-gray-900" method="post" id="login">
                ...
                <div class="flex items-center border-2 border-gray-300 dark:border-gray-700 py-2 px-3 rounded-2xl">
                ...
                <button type="submit"
                        class="block w-full bg-indigo-600 dark:bg-indigo-500 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">
                    Login
                </button>
                <a href="/login/forgot"
                   class="text-sm ml-2 text-gray-700 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 cursor-pointer">Forgot
                    Password?</a>

                <!-- Register Section -->
                <div class="flex items-center justify-center mt-6">
                    <p class="text-gray-700 dark:text-gray-400">Not a member?</p>
                    <a href="/register" class="ml-1 text-gray-800 dark:text-gray-100 font-bold underline">Register</a>
                </div>

                <a href="#"
                   class="block w-full bg-white dark:bg-gray-800 py-2 mt-2 rounded-2xl text-gray-700 dark:text-gray-300 font-semibold mb-2 flex items-center justify-center border border-gray-300 dark:border-gray-700">
                    <img src="https://logos-world.net/wp-content/uploads/2020/09/Google-Symbol.png" alt="Google Icon"
                         class=" h-5 mr-2 ml-4 text-left"/>
                    Google login
                </a>
            </form>
        </div>
    ...
    <script>
        document.getElementById('login').onsubmit = function () {
            this.action = '/login'; // Set the action URL dynamically
        }
